...
/**********************cart insert************************/
insert into cart(cart_no,user_Id,p_no,cart_qty) values (cart_cart_no_SEQ.nextval,'cream1',11,1);
insert into cart(cart_no,user_Id,p_no,cart_qty) values (cart_cart_no_SEQ.nextval,'cream1',12,2);
insert into cart(cart_no,user_Id,p_no,cart_qty) values (cart_cart_no_SEQ.nextval,'cream2',13,3);
insert into cart(cart_no,user_Id,p_no,cart_qty) values (cart_cart_no_SEQ.nextval,'cream2',11,7);
insert into cart(cart_no,user_Id,p_no,cart_qty) values (cart_cart_no_SEQ.nextval,'cream3',15,5);
...
insert into order_item(oi_no,oi_qty,o_no,p_no) values(order_item_oi_no_SEQ.nextval,1,orders_o_no_SEQ.currval,11);
insert into order_item(oi_no,oi_qty,o_no,p_no) values(order_item_oi_no_SEQ.nextval,1,orders_o_no_SEQ.currval,12);

insert into orders(o_no,o_desc,o_date,o_price,user_Id) values (orders_o_no_SEQ.nextval,'shoes2외0종',sysdate-1,22222,'cream2');
insert into order_item(oi_no,oi_qty,o_no,p_no) values(order_item_oi_no_SEQ.nextval,1,orders_o_no_SEQ.currval,13);

insert into orders(o_no,o_desc,o_date,o_price,user_Id) values (orders_o_no_SEQ.nextval,'shoes3외1종',sysdate,33333,'cream3');
insert into order_item(oi_no,oi_qty,o_no,p_no) values(order_item_oi_no_SEQ.nextval,1,orders_o_no_SEQ.currval,13);
insert into order_item(oi_no,oi_qty,o_no,p_no) values(order_item_oi_no_SEQ.nextval,2,orders_o_no_SEQ.currval,14);
