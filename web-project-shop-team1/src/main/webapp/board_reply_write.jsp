								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
											<input value="[RE]<%=board.getBoard_title()%>"  type="text" style="width: 150"
											name="title">
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
											<textarea name="content" class="textarea" style="width: 350px" rows="14">>><%=board.getBoard_content().replace("\n",">>").trim()%></textarea>
										</td>
									</tr>
