...
<ul>
	...
	<%} %>
		<li><a href="product_list.jsp?category_no=1">운동화</a></li>
		<li><a href="product_list.jsp?category_no=2">구두</a></li>
		<li><a href="product_list.jsp?category_no=3">부츠</a></li>
		<li><a href="product_list.jsp?category_no=4">슬리퍼</a></li>
